...
public class QuizModule extends JPanel implements Quizable {
    ...
    /**
     * Public getter for Member 1 (MainApp) to attach a Back to Menu listener
    ...
    /**
     * Public getter for Member 4 (GameManager) to get the final score
    ...
    /**
     * Public getter for Member 4 (GameManager) to get the final percentage
